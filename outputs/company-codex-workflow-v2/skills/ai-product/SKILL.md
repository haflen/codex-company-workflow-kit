---
name: ai-product
description: Use when LLM, RAG, prompt, AI-agent, provider API, AI safety, model behavior, or AI product feasibility needs expert product judgment.
upstream_risk: safe
upstream_source: vibeship-spawner-skills (Apache 2.0)
...
## Optimistic UI:
Return immediately with a safe fallback
